...
FACTURA_FIELDS = [
    ...
    {"key": "curs_bnr", "label": "Curs BNR:", "type": "text", "required": False},
    ...
    {"key": "avans_contract", "label": "Avans contract:", "type": "text", "required": False},
    {"key": "diferenta_contract", "label": "Diferenta contract:", "type": "text", "required": False},
]

PLACEHOLDER_MAP = {
    "nr": "NrContract", "data": "DataContract", "nume": "NumeCompanie",
    "loc": "TownCompany", "adresa": "AdressCompany", "tel": "PhoneCompany",
    "cod_fiscal": "FiscalCodeCompany", "inmatriculare_rc": "NumberRCCompany",
    "cont": "ContCompanie", "banca": "BankCompany",
    "reprezentata_prin": "RepresentativeCompany", "cnp": "CNPReprezentantCompanie",
